        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container">
                ...
                <a class="navbar-brand" href="index.php">
                    <img src="public/images/Property.png" alt="" class="img-fluid">
                </a>
                <!-- logo end -->
                <!-- Toggle start -->
            ...
            <div class="row">
                <div class="col-lg-8 m-auto">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="resource/auth/login_post.php" method="post" enctype="multipart/form-data">
                                <?php if(!empty($_GET['ermess'])){ ?>
                                <div class="alert alert-danger mt-1 mb-0" role="alert">
                                    <?php echo $_GET['ermess'];?>
                                </div>
                                <?php }?>
                                <?php if(!empty($_GET['errmess'])){ ?>
                                <div class="alert alert-danger mt-1 mb-0" role="alert">
                                    <?php echo $_GET['errmess'];?>
                                </div>
                                <?php }?>
                                <div class="row">
